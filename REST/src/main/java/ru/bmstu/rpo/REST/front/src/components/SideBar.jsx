        ...
        <>
            { props.expanded &&
                <Nav className={"flex-column my-sidebar my-sidebar-expanded"}>
                    <Nav.Item><Nav.Link as={Link} to="/profile"><FontAwesomeIcon icon={faUser} />{' '}Пользователи</Nav.Link></Nav.Item>
            ...
            { !props.expanded &&
                <Nav className={"flex-column my-sidebar my-sidebar-collapsed"}>
                    <Nav.Item><Nav.Link as={Link} to="/profile"><FontAwesomeIcon icon={faUser} size="2x" /></Nav.Link></Nav.Item>
